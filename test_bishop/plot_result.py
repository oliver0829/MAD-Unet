# -------------------------------------------------------------
# File: test_bishop\plot_result.py
# Author: Qiang Li
# Date of Completion: June 27, 2024
# Description: plot result for Figure 16
# -------------------------------------------------------------
...
for index, batch in enumerate(data_loader):
    ...
    # get TMI
    tmi_data = pd.read_csv(f'./csv/TMI_{incl[index]}.csv', sep=',', header=None).to_numpy()
    tmi = interpolate(tmi_data, 100, 100)
